...
comment on column bts_ref_item.update_detime is '수정일시';
...
(
    ...
    take_qnty       varchar(100)         not null,
    eng_take_qnty   varchar(100)         not null,
    use_qnty        varchar(100)         not null,
    eng_use_qnty    varchar(100)         not null,
    strg_method_cd  varchar(50)          not null,
    spcm_stbl       varchar(1000),
    eng_spcm_stbl   varchar(1000),
    take_method     varchar(1000),
    eng_take_method varchar(1000),
    spcm_desc       varchar(1000)        not null,
    eng_desc        varchar(1000),
    caution         varchar(1000)        not null,
    eng_caution     varchar(1000)        not null,
...
comment on column bts_spcm.strg_method_cd is '보관방법';
...
comment on column bts_spcm.update_detime is '수정일시';
...
comment on column bbs_dept_group.update_detime is '수정일시';
...
comment on column bbs_dept_grp_itm.update_detime is '수정일시';
...
comment on column bbs_tst_req_doc.update_detime is '수정일시';

alter table bbs_tst_req_doc
    owner to ailis_user;

create table rbs_doc
(
    ...
    constraint rbs_doc_unique
        unique (patient_id, atch_file_id)
);

comment on table rbs_doc is '검사의뢰 (의뢰문서)';

comment on column rbs_doc.doc_id is 'UUID';

comment on column rbs_doc.patient_id is '의뢰문서 UUID';

comment on column rbs_doc.atch_file_id is '첨부파일';

comment on column rbs_doc.tst_req_dt is '의뢰일자';

comment on column rbs_doc.tst_req_no is '의뢰번호';

comment on column rbs_doc.creator is '생성자';

comment on column rbs_doc.create_dtime is '생성일시';
...
comment on column bbs_tst_ref_group_item.update_detime is '수정일시';
...
(
    ...
    create_dtime     timestamp    not null,
    updater          varchar(50)  not null,
    updat_dtime      timestamp    not null
);
...
comment on column rup_excel_info.updat_dtime is '수정일시';
...
comment on column rup_excel_req_info.updat_dtime is '수정일시';
...
comment on column bbs_dept_tst_item.update_detime is '수정일시';
...
(
    ...
    ref_abbr_nm     varchar(200) not null,
    ref_eng_nm      varchar(200) not null,
    ref_eng_abbr_nm varchar(200) not null,
    sort_order      integer      not null,
    creator         varchar(50)  not null,
    create_dtime    timestamp    not null,
    updater         varchar(50)  not null,
...
comment on column bbs_tst_ref_group.update_detime is '수정일시';
...
(
    ...
    tst_req_dt   date         not null,
    tst_req_no   bigint       not null,
    ref_item_cd  varchar(50)  not null,
    ...
    constraint rbs_ref_item_unique
        unique (tst_req_dt, tst_req_no, ref_item_cd)
);
...
comment on column rbs_ref_item.ref_item_cd is '참조항목';
...
comment on column rbs_ref_item.updat_dtime is '수정일시';
...
comment on column rbs_spcm.updat_dtime is '수정일시';
...
(
    ...
    lims_aaply_yn    boolean default false not null,
    lims_aaply_dtime timestamp,
    tst_req_dt       date                  not null,
    tst_req_no       bigint                not null,
    ref_item_cd      varchar(50)           not null,
    ref_cont         varchar(500)          not null,
...
comment on column rbs_ref_item_hst.lims_aaply_yn is 'LIMS적용여부';

comment on column rbs_ref_item_hst.lims_aaply_dtime is 'LIMS적용일시';

comment on column rbs_ref_item_hst.tst_req_dt is '의뢰일자';

comment on column rbs_ref_item_hst.tst_req_no is '의뢰번호';

comment on column rbs_ref_item_hst.ref_item_cd is '참조항목';
...
comment on column rbs_ref_item_hst.updat_dtime is '수정일시';
...
comment on column rbs_spcm_hst.lims_aaply_yn is 'LIMS적용여부';

comment on column rbs_spcm_hst.lims_aaply_dtime is 'LIMS적용일시';
...
comment on column rbs_spcm_hst.updat_dtime is '수정일시';
...
(
    ...
    rst_short         varchar(500),
    rst_txt           text,
    rst_file_path     varchar(50),
    rst_url           varchar(200),
    delivery_yn       boolean default false,
    delivery_cd       varchar(50),
    delivery_dtime    timestamp,
    deliverer         varchar(50),
    creator           varchar(50) not null,
...
comment on column tbs_tst_report_hst.rst_file_path is '결과파일';
...
comment on column rbs_patient_hst.lims_aaply_yn is 'LIMS적용여부';

comment on column rbs_patient_hst.lims_aaply_dtime is 'LIMS적용일시';
...
comment on column rbs_patient_hst.updat_dtime is '수정일시';
...
comment on column rbs_patient.updat_dtime is '수정일시';
...
comment on column bbs_spcm.coll_amt is '채취량';

comment on column bbs_spcm.eng_coll_amt is '채취량(영문)';

comment on column bbs_spcm.spcm_strg is '검체보관';

comment on column bbs_spcm.eng_spcm_strg is '검체보관(영문)';

comment on column bbs_spcm.spcm_safe is '검체안정성';

comment on column bbs_spcm.eng_spcm_safe is '검체안정성(영문)';

comment on column bbs_spcm.caution is '주의사항';

comment on column bbs_spcm.eng_caution is '주의사항(영문)';

comment on column bbs_spcm.ref is '참고사항';

comment on column bbs_spcm.eng_ref is '참고사항(영문)';
...
comment on column bbs_spcm.update_detime is '수정일시';
...
(
    ...
    web_yn             boolean default true               not null,
    ...
    tst_int_nm         varchar(200)                       not null,
    ...
    disease_cd         varchar(50)                        not null,
    tst_method_cd      varchar(50),
    ref_val            varchar(1000)                      not null,
    eng_ref_val        varchar(1000)                      not null,
    clnc_sgnf          varchar(4000)                      not null,
    eng_clnc_sgnf      varchar(4000)                      not null,
    tst_desc           varchar(4000)                      not null,
    tst_eng_desc       varchar(4000)                      not null,
    tst_dayweek        varchar(100)                       not null,
    tst_tatday         integer                            not null,
    insu_apply_cd      varchar(50)                        not null,
    insu_cd            varchar(50)                        not null,
    insu_cate_no       varchar(50)                        not null,
    creator            varchar(50)                        not null,
    create_dtime       timestamp                          not null,
    updater            varchar(50),
    update_detime      timestamp
...
comment on column bts_item.web_yn is '편람적용여부';
...
comment on column bts_item.update_detime is '수정일시';
...
(
    ...
    rst_type_url_yn    boolean       not null,
    disease_cd         varchar(50)   not null,
    tst_method_cd      varchar(50)   not null,
    ref_val            varchar(1000) not null,
    eng_ref_val        varchar(1000) not null,
    clnc_sgnf          varchar(4000) not null,
    eng_clnc_sgnf      varchar(4000) not null,
    ...
    tst_eng_desc       varchar(4000) not null,
    tst_dayweek        varchar(100)  not null,
    tst_eng_dayweek    varchar(100)  not null,
    tst_tatday         integer       not null,
    insu_apply_cd      varchar(50)   not null,
    insu_cd            varchar(50)   not null,
    insu_cate_no       varchar(50)   not null,
...
comment on column bts_item_hst.web_yn is '편람적용여부';
...
comment on column bts_item_hst.tst_eng_dayweek is '검사일(영문)';
...
comment on column bts_item_hst.update_detime is '수정일시';
...
comment on column bbs_tst_cate.update_detime is '수정일시';
...
(
    ...
    cntn_file_id  varchar(50)  not null,
    creator       varchar(50)  not null,
    create_dtime  timestamp    not null,
    updater       varchar(50)  not null,
    update_detime timestamp    not null
...
comment on column bbs_spcm_cntn.update_detime is '수정일시';
...
(
    ...
    tst_req_no          bigint      not null,
    tst_cd              varchar(50) not null,
    before_change_price varchar(50),
    after_change_price  varchar(200),
    price_change_cd     varchar(50),
    tst_item_set_yn     boolean default false,
    appr_info_id        varchar(50),
...
comment on column rbs_amt_chg.appr_info_id is '결재정보아이디';
...
comment on column rbs_amt_chg.updat_dtime is '수정일시';
...
(
    ...
    tst_req_stat_cd           varchar(50),
    spcm_cd                   varchar(50),
    req_check_dtime           timestamp,
    req_check_user_id         varchar(50),
    ...
    special_charge            numeric default 0     not null,
    ...
    exrt_id                   bigint,
    closing_special_charge    numeric,
...
comment on column rbs_tst_item.req_check_dtime is '의뢰확인일시';

comment on column rbs_tst_item.req_check_user_id is '의뢰확인자';
...
comment on column rbs_tst_item.special_charge is '특별수가';
...
comment on column rbs_tst_item.closing_special_charge is '특별수가(마감)';
...
comment on column rbs_tst_item.updat_dtime is '수정일시';
...
comment on column rbs_tst_item_hst.lims_aaply_yn is 'LIMS적용여부';

comment on column rbs_tst_item_hst.lims_aaply_dtime is 'LIMS적용일시';
...
comment on column rbs_tst_item_hst.req_check_dtime is '의뢰확인일시';

comment on column rbs_tst_item_hst.req_check_user_id is '의뢰확인자';
...
comment on column rbs_tst_item_hst.special_charge is '특별수가';
...
comment on column rbs_tst_item_hst.closing_special_charge is '특별수가(마감)';
...
comment on column rbs_tst_item_hst.updat_dtime is '수정일시';
...
(
    ...
    dft_data        varchar(1000)         not null,
    dft_eng_data    varchar(1000)         not null
...
comment on column bbs_tst_ref.ref_cate_cd is '분류';
...
comment on column bbs_tst_ref.update_detime is '수정일시';
