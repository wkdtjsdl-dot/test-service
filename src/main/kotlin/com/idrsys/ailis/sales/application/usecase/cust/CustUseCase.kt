...
interface CustUseCase {
    suspend fun getCustPage(searchParam: CustSearchParam, pageable: Pageable): Page<CustListResponse>
    fun getCusts(searchParam: CustSearchParam): Flow<CustListResponse>
