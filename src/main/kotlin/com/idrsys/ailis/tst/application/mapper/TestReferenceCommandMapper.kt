...
import com.idrsys.ailis.tst.application.dto.TestReferenceGroupItemUpdateRequest
import com.idrsys.ailis.tst.application.dto.TestReferenceGroupRegisterRequest
import com.idrsys.ailis.tst.application.dto.TestReferenceGroupUpdateRequest
...
interface TestReferenceCommandMapper {
    ...
    fun toUpdateCommand(request: TestReferenceGroupUpdateRequest): TestReferenceGroupUpdateCommand

    fun toCreateCommand(request: TestReferenceGroupItemRegisterRequest): TestReferenceGroupItemCreateCommand

    fun toUpdateCommand(request: TestReferenceGroupItemUpdateRequest): TestReferenceGroupItemUpdateCommand
}
