...
class TestItemServiceTest {
    ...
    @Test
    fun `deleteItem should call repository delete`() = runTest {
        // Given
        val id = "uuid"
        val domain = TestItem(
            tstCd = id,
    ...
    @Test
    fun `getAllItems should return flow of responses`() = runTest {
        // Given
        val domain = TestItem(
            tstCd = "uuid",
            tstLargeCateCd = "L01",
        ...
        // When
        val result = service.getAllItems().toList()
